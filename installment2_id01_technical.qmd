...
```{r interacion_model, warning=FALSE}
...
# TODO: why ggplot? => 
# A: artefact of exploration phase, 
# we kept it so we'd remember how to make similar plots
...
``` {r prediction_evaluation, warning=FALSE}
